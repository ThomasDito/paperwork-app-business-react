        ...
        >
          <Link
            className={cn(
              ...
              !collapsed || menuHover ? "justify-start" : "flex-1"
            )}
            to="/"
          >
            <div
              className={cn(
                "relative flex flex-nowrap h-12 overflow-hidden",
                !collapsed || menuHover ? "w-auto " : "w-12"
              )}
            >
              {!collapsed || menuHover ? (
                <img
          ...
          <div
            className={cn(
              "absolute -right-4 z-100 transition-opacity duration-200",
              !menuHover && "opacity-0",
          ...
          >
            ...
            >
              <ChevronLeft
                className={cn(
                  "w-4 h-4 transition-transform duration-300 scale-x-100",
                  collapsed && "scale-x-[-1]"
                )}
              />
            </Button>
