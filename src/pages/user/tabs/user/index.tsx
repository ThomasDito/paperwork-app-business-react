...
export const profileUpdateSchema = z
  .object({
    ...
    user_phone: z
      .string()
      .regex(
        new RegExp("^(^\\+62|62|^08)(\\d{3,4}-?){2}\\d{3,4}$"),
...
export default function UserTabIndex() {
    ...
    if (user) {
      setInitialValues({
        ...
        user_birthdate: user.user_birthdate
          ? moment(user.user_birthdate).toDate()
          : null,
  ...
  const onSubmit = async (
    ...
    formikHelpers: FormikHelpers<ProfileUpdateSchemaType>
  ) => {
    ...
    if (values.user_address)
      payload.append("user_address", values.user_address);
    ...
    if (values.user_birthdate) {
      payload.append(
        "user_birthdate",
        moment(values.user_birthdate).utc(true).format("YYYY-MM-DD")
      );
    }
  ...
  if (error) {
    ...
    const message =
      data?.message || "Terjadi kesalahan teknis. Silahkan coba kembali";
      ...
      <div className="rounded-md shadow bg-card">
        ...
        <div className="p-5">
          <Formik
            ...
            validate={withZodSchema(profileUpdateSchema)}
            onSubmit={onSubmit}
                  ...
                  <div className="col-span-1 lg:col-span-5 space-y-7">
                    ...
                    <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
                      <FormikDatePicker
                        ...
                        ButtonProps={{
                          disabled: !isEdit,
                          className: "max-w-[none] w-full bg-card",
                        }}
                        name="user_birthdate"
                  ...
                  <div className="col-span-1 space-y-2 lg:col-span-3">
                    ...
                    <div
                      className={cn(
                        ...
                        props.touched.user_avatar &&
                          props.errors.user_avatar &&
                          "border-destructive"
                      )}
                    >
                      <div className="py-5">
                ...
                {isEdit && (
                  <div className="flex justify-end pt-8">
                    <Button
                      type="submit"
                      disabled={
                        updateUserIsLoading || !(props.dirty && props.isValid)
                      }
                    >
                      {updateUserIsLoading && (
