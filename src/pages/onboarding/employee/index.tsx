...
export default function OnboardingEmployeeIndex({ setTabs }: Props) {
  return (
    <div className="">
      <div className="mb-10">
        <Button className="">
          <LucidePlus className="w-5 h-5 mr-2" /> Tambah Pegawai
        </Button>
      </div>
      ...
      <div className="mt-14 flex items-center justify-end space-x-5">
        <Button variant="outline" onClick={() => setTabs("welcome")}>
