import DivisionSkeleton from "@/pages/setting/division/components/skeleton";
                  ...
                  <TableRow key={division.id}>
                    ...
                    <TableCell className="py-2 px-5 text-center">
                      <div className="flex justify-center space-x-2">
                        <Link
                          to={`/setting/division/form/${division.id}`}
                          state={{ previousLocation: location }}
                        >
                          <Button
                            variant="ghost"
                        ...
                        <Link
                          to={`/setting/division/delete/${division.id}`}
                          state={{ previousLocation: location }}
                        >
                          <Button
                            variant="ghost"
